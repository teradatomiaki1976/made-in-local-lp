...
export default function HeroPhase({ onShowHeader }: HeroPhaseProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative z-30 flex flex-col items-center text-center pointer-events-none py-48 px-16 rounded-full bg-[radial-gradient(circle,#fefbf1_60%,transparent_100%)]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
