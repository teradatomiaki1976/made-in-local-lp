      ...
      <div className="sticky top-0 left-0 w-full h-svh flex flex-col overflow-hidden">
        ...
        <div className="relative w-full flex-[0.4] flex items-end justify-center bg-creem pb-6 md:pb-12 px-6 z-20">
          ...
          <motion.div
            ...
            className="absolute text-center w-full"
          >
            <h2 className="flex flex-col gap-2 md:gap-4 text-4xl md:text-6xl font-bold tracking-normal text-midblue leading-tight">
              <span className="block text-base md:text-3xl leading-tight text-midblue">
                私たちが次世代に紡いでいく日本は
                <br />
                衰退していく日本ではなく
              </span>
